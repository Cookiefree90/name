...
class TestDocsApiBatchUpdate:
    ...
    def test_batch_update_method_conversion(self, prepared_docs_converter, docs_api_spec):
    ...
    def test_batch_update_request_schema_conversion(self, prepared_docs_converter, docs_api_spec):
    ...
    def test_batch_update_response_schema_conversion(self, prepared_docs_converter, docs_api_spec):
    ...
    def test_batch_update_request_types_conversion(self, prepared_docs_converter, docs_api_spec):
    ...
    def test_convert_methods(self, prepared_docs_converter, docs_api_spec):
        ...
        assert (
            post_method["requestBody"]["content"]["application/json"]["schema"]["$ref"]
            == "#/components/schemas/Document"
        )

        # Check response
        assert (
            post_method["responses"]["200"]["content"]["application/json"]["schema"]["$ref"]
            == "#/components/schemas/Document"
        )
    ...
    def test_batch_update_example_request_structure(self, prepared_docs_converter, docs_api_spec):
